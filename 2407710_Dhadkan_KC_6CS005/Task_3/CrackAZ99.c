...
int main(int argc, char *argv[]){
  crack("$6$XY$k4c48gZqelvDJeVqb5s.JOb3or1TBk.aR8PzVD4eylvvA93iArPTnJtlZRXPRBl9t5L9dpZljECHJjirzLZBT0");		//Copy and Paste your ecrypted password here using EncryptShA512 program
